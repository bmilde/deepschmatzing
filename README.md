...
The Eating Condition classification task is to determine if a short audio sequences is either "No Food", "Banana", "Crisp", "Nectarine", "Haribo", "Apple", "Biscuit", based on training and testing data from the iHEARu-EAT corpus.  Speakers eat while they speak and recite a poem.
